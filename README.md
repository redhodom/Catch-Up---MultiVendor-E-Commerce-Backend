...
Catch-Up is a secure MultiVendor E-Commerce Backend built with Java Spring Boot, Spring Security, JWT, Hibernate, JPA, MySQL, and Swagger OpenAPI featuring customer, seller, and admin modules.
Repository Topics
